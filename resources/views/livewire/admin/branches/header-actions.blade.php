<div>
  {{-- Confirmation Modals (NOW INSIDE THE ROOT DIV) --}}
  {{-- Single Delete Confirmation Modal --}}
  <flux:modal name="delete-confirmation" class="min-w-88">
    <div class="space-y-6">
      <div>
        <flux:heading size="lg">Remove Branch?</flux:heading>
      ...
      <div class="flex gap-2">
        ...
        <flux:button variant="danger" wire:click="destroy">Remove</flux:button>
      </div>
    </div>
  </flux:modal>
  ...
  <flux:modal name="bulk-delete-confirmation" class="min-w-88">
    <div class="space-y-6">
      <div>
        <flux:heading size="lg">Delete Selected Branches?</flux:heading>
  ...
  <flux:modal name="force-delete-confirmation" class="min-w-88">
    <div class="space-y-6">
      <div>
        <flux:heading size="lg">Permanently Delete Branch?</flux:heading>
      ...
      <div class="flex gap-2">
        ...
        <flux:button variant="danger" wire:click="forceDestroy">Delete</flux:button>
      </div>
    </div>
  </flux:modal>
</div>